...
> [COLT: Cyclic Overlapping Lottery Tickets for Faster Pruning of Convolutional Neural Networks](https://arxiv.org/) by [Md. Ismail Hossain](), [Mohammed Rakib](), [MM Lutfe Elahi](), [Nabeel Mohammed](), and [Shafin Rahman]()
...
### how to run LTH ? 
```
python3 main.py --prune_type=lth --arch_type=resnet18 --dataset=cifar100 --output_class=100
```
### Arguments
...
python3 transfer.py --prune_type=colt --arch_type=resnet18 --dataset=cifar100 --part1=full --part2=full
...
||`--part1`|``|A \| B -whose weights will be transferred|
||`--part2`|`full`|A \| B \| full -which will be trained on transferred weights|
||`--bias`|`0`|prune bias or not|
