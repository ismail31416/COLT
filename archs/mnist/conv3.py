...
class conv3(nn.Module):
    ...
    def forward(self, s):
        ...
        s = self.bn2(self.conv2(s))                         # batch_size x num_channels*2 x 14 x 14
        s = F.relu(F.max_pool2d(s, 2))                      # batch_size x num_channels*2 x 7 x 7
        s = self.bn3(self.conv3(s))                         # batch_size x num_channels*4 x 7 x 7
